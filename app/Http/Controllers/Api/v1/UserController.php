...
class UserController extends BaseController
{
    ...
    */
    ...
    public function register(RegistrationRequest $request,RegistrationService $registrationService){
        try {
            $user = $registrationService->saveData($request->except(['confirm_password']),$this->userRepository);
            return $this->sendResponse($user,'Registration successfully',Response::HTTP_CREATED);
        } catch (\Exception $e) {
